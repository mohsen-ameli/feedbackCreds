...
import { MAX_WRITTEN_RESPONSE_LENGTH, MIN_WRITTEN_RESPONSE_LENGTH } from '../../data/Constants'
...
const WrittenResponse = ({ question, setDataToSubmit }) => {
  ...
  const onChange = (e) => {
    ...
    if (words.length >= MIN_WRITTEN_RESPONSE_LENGTH && words.length <= MAX_WRITTEN_RESPONSE_LENGTH) {
      // Save the data

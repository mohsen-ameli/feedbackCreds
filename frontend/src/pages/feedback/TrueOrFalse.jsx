  ...
  return <>
    <div className="flex flex-col items-center gap-y-8 w-full">
      ...
      <div className="w-full flex items-center justify-around text-lg">
        <Clicky
          onClick={(e) => {playConfetti(e); setHappy(1)}}
          className={"rounded-full " + (happy === 1 ? "shadow-selected" : "shadow-none")}
        >
        ...
        <Clicky
          onClick={() => setHappy(0)}
          className={"rounded-full " + (happy === 0 ? "shadow-selected" : "shadow-none")}
        >
